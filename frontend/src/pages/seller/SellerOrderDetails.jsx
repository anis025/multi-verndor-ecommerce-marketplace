...
export default function SellerOrderDetails() {
  ...
  const handleStatusUpdate = async (productId, newStatus) => {
    try {
      await api.put(`/seller/orders/${id}/items/${productId}/status`, { status: newStatus });
      fetchOrder();
    } catch {
      // silent
    }
  ...
  return (
    <div className="page">
      <div className="container">
        <button className="btn btn-outline btn-back" onClick={() => navigate("/seller/orders")}>
          &larr; Back to Orders
        </button>
              ...
              {order.items.map((item, i) => (
                <div key={i} className="order-detail-item">
                  ...
                  <select
                    ...
                    onChange={(e) => handleStatusUpdate(item.product_id, e.target.value)}
